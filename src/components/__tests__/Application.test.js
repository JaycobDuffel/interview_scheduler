...
describe("Application", () => {
  ...
  // 4. Enter the new name into the input with the placeholder "Enter Student Name".
  fireEvent.change(getByPlaceholderText(appointment, /enter student name/i), {
    target: { value: "Jaycob Duffel" }});
  ...
  await waitForElement(() => getByText(appointment, "Jaycob Duffel"))
